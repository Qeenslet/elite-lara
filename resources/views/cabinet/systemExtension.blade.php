                            ...
                            @if(isset($centerObject['extra']))
                                <td>
                                    <div id="s{{$centerObject['id']}}" style="display: none;">
                                        @include('interface.starInsides')
                                    </div>
                                    <button class="btn btn-primary extraP" type="submit" data="{{$centerObject['id']}}" data-object="s" id="bs{{$centerObject['id']}}">Show star details</button>
                                </td>
                            @endif
                        </tr>
                    </table>
                            ...
                            @if(isset($planet['extra']))
                                <td>
                                    <div id="p{{$id}}" style="display: none;">
                                        @include('interface.planetInsides')
                                    </div>
                                    <button class="btn btn-primary extraP" type="submit" data="{{$id}}" data-object="p" id="bp{{$id}}">Show planet details</button>
                                </td>
                            @endif
                        </tr>
                    </table>
...
<script>
    function changeName(id, object)
    {
        ...
        {
            $('#b'+object+id).html('Hide '+name+' details');
        }
        else
        {
            $('#b'+object+id).html('Show '+name+' details');
        }
    }
</script>